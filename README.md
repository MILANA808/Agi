...
| File                                                      | Purpose                                                                |
| --------------------------------------------------------- | ---------------------------------------------------------------------- |
| `LICENSE`                                                 | Apache 2.0 license—free to use, modify, redistribute.                  |
...
| `requirements.txt`                                        | Python dependencies: bootloader, verify loop, PDF generator, etc.      |
...
### 📦 Inside `artifacts/` (formerly the tarball)
...
* **LLM Hooks**: drop `R-AGI_Substrate_Seed.json` into GPT-4, Claude, Grok, or any custom wrapper.
